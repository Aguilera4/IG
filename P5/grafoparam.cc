...
void GrafoParam::draw( const int p_modo_vis, const bool p_usar_diferido, int p_modo_dibujo)
{
    ...
    glPushMatrix();
		...
		glPushMatrix();
			...
			glTranslatef(0.0,0.57,0.0);
				cilindro->draw(modo_vis, modo_dibujo);
		glPopMatrix();
		...
		glPushMatrix();
			...
			glRotatef(ag_rotacion_2,0.0,1.0,0.0);
				big_dodge->draw(modo_vis, modo_dibujo);
		glPopMatrix();
	...
	glPushMatrix();
		...
		glPushMatrix();
			...
			glRotatef(90.0,0.0,1.0,0.0);
				cubo->draw(modo_vis, modo_dibujo);
		glPopMatrix();
	...
	glPushMatrix();
		...
		glPushMatrix(); // cono
			...
			glTranslatef(0.0,-0.5,0.0);
				cono->draw(modo_vis, modo_dibujo);
		glPopMatrix();
